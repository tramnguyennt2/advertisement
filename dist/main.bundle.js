...
var AdDetailComponent = /** @class */ (function () {
    function AdDetailComponent(http, pouchdb, route) {
        ...
        this.route = route;
        this.item = new __WEBPACK_IMPORTED_MODULE_4__ad__["a" /* Ad */]('', '', '', '', 0);
        this.display();
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__node_service__ = __webpack_require__("./src/app/node.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_21__node_service__["a" /* NodeService */]
            ],
...
module.exports = "<div class=\"container\">\r\n  <div class=\"row\">\r\n    <div class=\"col-md-6\">\r\n      <div class=\"panel-heading\">\r\n        <h3 class=\"panel-title\">Post Advertisement</h3>\r\n      </div>\r\n      <label>Title</label>      \r\n      <input class=\"form-control\" name=\"title\" [(ngModel)]=\"ad.title\" type=\"text\"/>\r\n      <label>Location</label>\r\n      <select class=\"form-control\" name=\"area\" [(ngModel)]=\"ad.area\">\r\n        <option>Hà Nội</option>\r\n        <option>Da Nang</option>\r\n        <option>Hồ Chí Minh</option>\r\n      </select>\r\n      <label>Category</label>\r\n      <select class=\"form-control\" name=\"category\" [(ngModel)]=\"ad.category\">\r\n        <option>Fashion</option>\r\n        <option>Pets</option>\r\n        <option>Home</option>\r\n      </select>\r\n      <label>Price</label>\r\n      <input class=\"form-control\" name=\"price\" [(ngModel)]=\"ad.price\" type=\"text\"/>\r\n      <label>Content</label>\r\n      <textarea class=\"form-control\" name=\"content\" type=\"textarea\" [(ngModel)]=\"ad.content\"></textarea>\r\n      <br>\r\n      <button class=\"btn btn-lg btn-primary btn-block\" type=\"submit\" (click)=\"addAd()\">Post</button>\r\n    </div>\r\n  </div>\r\n</div>\r\n"
...
var NodeService = /** @class */ (function () {
    ...
    NodeService.prototype.post = function (data) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_behavior__ = __webpack_require__("./src/app/user-behavior.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__ = __webpack_require__("./node_modules/rxjs/_esm5/add/operator/map.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__node_service__ = __webpack_require__("./src/app/node.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(nodejs, pouchdb, solr) {
        this.nodejs = nodejs;
        this.pouchdb = pouchdb;
        this.solr = solr;
        this.keyword = '';
        this.items = [];
        this.behavior = new __WEBPACK_IMPORTED_MODULE_3__user_behavior__["a" /* UserBehavior */](1);
        this.area = 'all';
        this.cat = 'all';
    }
    ...
    SearchComponent.prototype.saveUserBehavior = function (item_id) {
        ...
        this.nodejs.post(this.behavior).subscribe(function (res) { return console.log(res); });
    ...
    SearchComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__node_service__["a" /* NodeService */], __WEBPACK_IMPORTED_MODULE_1__pouchdb_service__["a" /* PouchdbService */], __WEBPACK_IMPORTED_MODULE_2__solr_service__["a" /* SolrService */]])
    ], SearchComponent);
